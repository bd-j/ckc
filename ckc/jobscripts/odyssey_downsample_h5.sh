...
#SBATCH -o /n/regal/conroy_lab/bdjohnson/run_ckc/logs/c3k_downsample_%A_%a.out # Standard out goes to this file
#SBATCH -e /n/regal/conroy_lab/bdjohnson/run_ckc/logs/c3k_downsample_%A_%a.err # Standard err goes to this file
...
python downsample_h5.py --resolution=5000 --smoothtype=R --oversample=3 \
       ...
       --ck_vers=c3k_v1.3 --verbose=True --np=${ncpu}
